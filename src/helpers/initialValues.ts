import { GeneralInfoInterface, EducationInterface, ExperienceInterface } from "./generalTypes";

const initialGeneralInfo: GeneralInfoInterface = {
    name: "James The Dog",
    email: "woof@dog.com",
    phone: "5512345678",
};
...
export {initialGeneralInfo, initialEducation, initialExperience};
